        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-7 py-4">
                    ...
                    <p class="text-muted">Shammah hotel is an international hotel which is owned by Shammah Internationals and based in Kenya. It was started in the year 2017 and it has 60 rooms for residence.</p>
                </div>
...
<main role="main">
    ...
    <section class="jumbotron text-center">
        <div class="container pt-lg-5 pl-5 px-5">
            <h1 class="display-3">A brand new hotel that goes above and beyond</h1>
            <p class="lead text-muted">Now is the time to book your holiday.</p>
            <p>
                <?php if ($isSessionExists) { ?>
    ...
    <div class="container">
        <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
            ...
            <p class="lead">The Shammah hotel offers three different types of rooms: deluxe, double, and single. The deluxe room is the most complicated and spacious, followed by the double room, and finally the single room.</p>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            <p class="card-text">The beautifully-appointed 24sqm Deluxe Room exudes utter sophistication and elegance, providing the best refuge to recharge the senses. Elevated ceilings and full-length bay windows distinguish each Deluxe Room on the higher floors, transforming your living space into an atmospheric dwelling.</p>
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <small class="text-muted">$40 / night</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            <p class="card-text">The normal twin room has two single beds that can accommodate two persons. A fully air conditioned twin room is the ideal choice for your needs, with an attractive set of top-notch facilities and the highest level of security. Book hotel accommodations with us and make the most of your trip.</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <?php if ($isSessionExists) { ?>
                                ...
                                <?php } ?>
                                <small class="text-muted">$30 / night</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            <p class="card-text">A single room with a reasonably sized en suite bathroom with shower and/or bathtub, hairdryer, and complimentary toiletries. Free WiFi, a telephone, a minibar, and a flat-screen TV with a range of channels and films are among the amenities</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <?php if ($isSessionExists) { ?>
                                ...
                                <?php } ?>
                                <small class="text-muted">$25 / night</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="container1">
                    <div class="images-section1">
                        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" src="image/conference1.jpg" data-holder-rendered="true" style="height: 300px; width: 50%; display: block;">
                        <p>The International Convention Hall of the Shammah Hotel is an exceptional conference facility. Its main draw is its central location within the city, as well as secure parking for up to 50 cars.The conference rooms can accommodate up to 200 people and are ideal for business meetings, seminars, product launches, and workshops. You may reserve the hall whenever you want.</p>
                        <div class="d-flex1 justify-content-between align-items-center">
                                ...
                                <?php } else { ?>
                                <button type="button" class="btn1 btn-sm btn-outline-success" data-toggle="modal" data-target=".sign-in-to-book-modal">
                                    Book
                                </button><br>
                                <?php } ?>
                                <big class="text-muted">$30 / per day</big>
                        </div>
                       
                    </div>
                    <div class="images-section2">
                        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" src="image/swimming_pool.jpg" data-holder-rendered="true" style="height: 300px; width: 50%; display: block;">
                        <p>The Shammah Hotel offers a swimming pool area that is available to all hotel guests at no cost. Come and have a good time!! THE SWIMMING POOL IS FREE OF CHARGE!!!</p>
                        
                        
                    </div>
                   <div class="images-section3">
                        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" src="image/Gym1.jpg" data-holder-rendered="true" style="height: 300px; width: 50%; display: block;">
                        <p>In our state-of-the-art exercise center, you may rejuvenate and refresh at any time. A cutting-edge gym with free weights, strength training, and cardio equipment is available at the Shammah hotel. Over 200 resistance-based exercises are possible.Shammah's private boxing room is ideal for anyone seeking to learn how to "fly like a butterfly or sting like a bee!" Hotel guests can take private boxing instruction from boxing specialists.</p>
                        <div class="d-flex justify-content-between align-items-center">
                                <?php if ($isSessionExists) { ?>
                                <button type="button" class="btn btn-sm btn-outline-success" data-rtype="Double" data-toggle="modal" data-target=".book-now-modal-lg">
                                    Book
                                ...
                                <?php } else { ?>
                                <button type="button" class="btn3 btn-sm btn-outline-success" data-toggle="modal" data-target=".sign-in-to-book-modal">
                                    Book
                                </button><br><br>
                                <?php } ?>
                                <big class="text-muted">$10 / per day</big>
                        </div>
                    </div>
                    <div class="images-section4">
                        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" src="image/spa.jpeg" data-holder-rendered="true" style="height: 300px; width: 50%; display: block;">
                        <p>Guests of the Shammah hotel can take advantage of the numerous spa amenities provided. You have the option of starting your treatment with a steam or ending it with time in the jacuzzi. Shammah Hotel has a fitness center, an outdoor heated pool, and a pool bar in addition to a wide selection of treatments and spa amenities.</p>
                        <div class="d-flex justify-content-between align-items-center">
                                <?php if ($isSessionExists) { ?>
                                <button type="button" class="btn btn-sm btn-outline-success" data-rtype="Double" data-toggle="modal" data-target=".book-now-modal-lg">
                                    Book
                                ...
                                <?php } else { ?>
                                <button type="button" class="btn4 btn-sm btn-outline-success" data-toggle="modal" data-target=".sign-in-to-book-modal">
                                    Book
                                </button><br><br>
                                <?php } ?>
                                <big class="text-muted">$10 / per day</big>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>You have to <a href="sign-in.php">sign in</a> in order to book.</h4>
                </div>
            </div>
        </div>
    </div>
